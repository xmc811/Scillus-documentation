...
=======
date: 2020-09-23
>>>>>>> c5c815c28b417bdc50e4543f8ed7c28bc7b03f85
...
The parameter `pal_setup` supports three types of inputs: `RColorBrewer` palette name, palette setup dataframe (See [Initial Setup](configuration.html), the last section), and manually specified color vector. The default value is the palette `"Set2"`. Currently, only `RColorBrewer` palettes are supported.
